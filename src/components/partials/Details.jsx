...
export default function Details(props) {
    ...
    const handleFavoriteClick = async () => {
        ...
        const gameIndex = currentUser.favoriteGames.indexOf(props.gameDetails.id)
        ...
        if (gameIndex !== -1) {
            ...
            updatedFavoriteGames = [...currentUser.favoriteGames, props.gameDetails.id]
        }
        setCurrentUser({
            ...currentUser,
        ...
        <div>
            {!props.gameDetails ? 
                ...
                <div className="game-div">
                    ...
                    <img className="game-img" src={props.gameDetails.background_image} alt="" />
                    <button onClick={handleFavoriteClick}>
                        {currentUser.favoriteGames.includes(props.gameDetails.id) ? 'Un-favorite' : 'favorite'}
                    </button>
                </div>
            }
        </div>
